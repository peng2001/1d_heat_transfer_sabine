...
def run_model(time_record, cells_list, cells_temperatures_init):
    ...
    temperatures[0] = cells_temperatures_init; temperatures[0][0] = Temperature_left; temperatures[0][-1] = Temperature_right # set end boundaries to defined temperatures
